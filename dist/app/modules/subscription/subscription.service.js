...
const subscriptionPlan_model_1 = __importDefault(require("../subscriptionPlan/subscriptionPlan.model"));
...
/* Create Subscription */
const createSubscription = (accountId, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const subscriptionPlan = yield subscriptionPlan_model_1.default.findById(payload.subscriptionPlanId);
    if (!subscriptionPlan) {
    ...
    if (subscriptionPlan.isActive === false) {
        throw new AppError_1.default(http_status_1.default.BAD_REQUEST, "Subscription plan is not active");
    }
    ;
    ...
    const subscription = yield subscription_model_1.default.create(payloadData);
    ...
    yield (0, sendSingleNotification_1.sendSingleNotification)(admin._id, "Subscription Purchased", `${user === null || user === void 0 ? void 0 : user.firstName} ${user === null || user === void 0 ? void 0 : user.lastName} has purchased subscription of ${subscriptionPlan.name}.`);
    return subscription;
});
/* Verify Subscription */
...
const getAllSubscriptions = (...args_1) => __awaiter(void 0, [...args_1], void 0, function* (filters = {}, skip = 0, limit = 10) {
    ...
    const result = yield (0, infinitePaginate_1.infinitePaginate)(subscription_model_1.default, query, skip, limit, ["user", "subscriptionPlanId"]);
    return result;
});
...
const getSingleSubscriptionById = (subscriptionId) => __awaiter(void 0, void 0, void 0, function* () {
    const subscription = yield subscription_model_1.default.findById(subscriptionId).populate("user subscriptionPlanId", "firstName lastName email profilePicture");
    if (!subscription) {
